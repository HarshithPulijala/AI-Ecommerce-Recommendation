...
Write-Host "`n[OK] Repository is synced with GitHub" -ForegroundColor Green
Write-Host ""
...
Write-Host "   - Click [Manual Deploy] then [Deploy latest commit]" -ForegroundColor Gray
Write-Host ""
Write-Host "3. If this is your first deployment:" -ForegroundColor White
Write-Host "   - Click [New +] then [Web Service]" -ForegroundColor Gray
...
Write-Host "  [OK] Installing Git LFS" -ForegroundColor Gray
Write-Host "  [OK] Pulling LFS files (data: 316 MB, models: 714 MB)" -ForegroundColor Gray
Write-Host "  [OK] Installing Python dependencies" -ForegroundColor Gray
Write-Host "  [OK] Starting Gunicorn server" -ForegroundColor Gray
Write-Host ""
